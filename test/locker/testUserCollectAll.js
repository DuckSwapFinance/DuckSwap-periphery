...
const { getPoolParts, getduckswapFactory} = require('../funcs')
...
describe("locker", function () {
    ...
    beforeEach(async function() {
        ...
        nflm = await getNFTLiquidityManager(duckswapFactory.address, weth9.address);
        console.log("get nflm");
        swap = await getSwap(duckswapFactory.address, weth9.address);
        lockTime = 7*24*60*60;
