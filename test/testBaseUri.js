...
const { getPoolParts, getduckswapFactory } = require("./funcs.js")
...
describe("swap", function () {
    ...
    beforeEach(async function() {
        ...
        duckswapFactory = await getduckswapFactory(signer.address, swapX2YModule, swapY2XModule, liquidityModule, limitOrderModule, flashModule, signer);
        console.log("get duckswapFactory");
    ...
    it("check fee after swap/add/dec", async function() {
        ...
        const okOwner_2 = await setBaseURI(nflm, signer, 'www.duck.com/');
